...
\textbf{Availability and Implementation: } A free and open-source software implementation of the methodology, the UCA R package, is made available via GitHub. Code for all analyses presented in this article is also available via GitHub. \\
\textbf{Contact: } robintu2@illinois.edu
\end{abstract}
  \end{@twocolumnfalse}
  ]
...
% With this constraint, cPCA++ no longer has the interpretation of variability because v is not normalized.
