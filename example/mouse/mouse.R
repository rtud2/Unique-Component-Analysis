...
plot_normal_saline <- rbind(
  ...
  data.table(target_data %*% pos_corr(uca_split, uca_bg1), "Unpooled", target_data_labs))
setnames(plot_normal_saline, c("UC1","UC2","Method","Label"))
plot_normal_saline[, Method:=factor(Method, levels = c("Memantine-C/S-Control", "Saline-C/S-Control", "Pooled", "Unpooled"))]
...
plot_normal_saline <- rbind(
  ...
  data.table(target_data %*% pos_corr(uca_split, uca_bg1), "Unpooled", target_data_labs))
setnames(plot_normal_saline, c("UC1", "UC2", "Method", "Label"))
plot_normal_saline[, Method:=factor(Method, levels = c("Memantine-S/C-Control", "Saline-S/C-Control", "Pooled", "Unpooled"))]
