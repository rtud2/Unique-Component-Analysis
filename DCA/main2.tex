...
\begin{figure}[!th]
  \centering
  \includegraphics[width = 0.78\textwidth]{figure/final_sess_eigenfaces.png}
  \caption{Top five eigenfaces of Female Actors from KDEF \cite{Calvo2008} for each emotion}
  \label{fig:Faces_by_emotion}
\end{figure}
\begin{figure}[!th]
  \centering
  \includegraphics[height = 0.78\textwidth]{figure/all_Sad_removed.png}
  \caption{Top five eigenfaces of Female Actors from KDEF \cite{Calvo2008} after removing all other Emotions except for Sad.}
  \label{fig:Faces}
\end{figure}
\begin{figure}[!th]
  \centering
  \includegraphics[width = 0.78\textwidth]{figure/all_projected_Sad_removed.png}
  \caption{Eigenfaces of Female Actors from KDEF \cite{Calvo2008} projected onto two dimensions after removing all other Emotions except for Sad.}
...
% Since UCA represents the best case, we did not compare to different values of contrastive tuning parameter lambda
...
% cPCA++ with the stacked background does not share the same features highlighted by using UCA with both practice emotions as the background in either the split or stack framework.
...
% Here it is clear that cPCA++ does not yield any advantage in emotional class separation over PCA and UCA.
